...
public class Raytracer {
    ...
    public static void main(String[] args) {
        ...
        Material sphere = new Material(.2f, .2f, .1f, 1, 0);
        Material teaPot = new Material(.2f, 1f, 10f, 1, 0);
        Material material2 = new Material(.2f, 10f, 20f, 1, 0);
        Material ring = new Material(.2f, 0f, 40f, 1, 0);

        scene01.setCamera(new Camera(new Vector3D(0, 0, -8), 160, 160, 400, 400, 5f, 50f, null));
        ...
        scene01.addLight(new PointLight(new Vector3D(0f, 0f, 0f), Color.WHITE, 1.3, null));
         //scene01.addObject(new Sphere(new Vector3D(0f, 1f, 5f), 0.5f, Color.RED, teaPot));
        ...
        scene01.addObject(OBJReader.GetPolygon("SmallTeapot.obj", new Vector3D(-1f, -3f, 1f), Color.BLUE, teaPot));
        //scene01.addObject(OBJReader.GetPolygon("Ring.obj", new Vector3D(2f, -1.0f, 1.5f), Color.BLUE));
        scene01.addObject(OBJReader.GetPolygon("yamelosaque.obj", new Vector3D(0f, -6.1f, 0f), Color.red, material2));
